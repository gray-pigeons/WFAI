...
namespace WFComponent
{
    public partial class ChatBox : UserControl
    {
        ...
        /// </summary>
        private readonly ConcurrentBag<BubbleBaseControl> _right_items = new ConcurrentBag<BubbleBaseControl>();
        ...
        private void ParentForm_ResizeEnd(object sender, EventArgs e)
        {
            ...
            foreach (BubbleBaseControl item in _right_items)
            {
        ...
        private void add_bubble<T>(BubbleBaseControl bubble, BubbleSide side, Action<T> action) where T : class
        {
